        ...
        <div>
          ...
          <div className="bg-pink-50 border border-pink-200 rounded-lg p-4">
            ...
            <p className="text-pink-800">
              "I'm willing to have this {emotion || 'experience'}, just as it is, not as I wish it
              to be, so that I can continue moving toward what matters to me."
            </p>
          </div>
        </div>
      ),
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="card bg-pink-50 border-pink-200">
        ...
        <p className="text-pink-800">
          Acceptance means opening up and making room for difficult feelings, sensations, thoughts,
          and urges - allowing them to come and go without struggling with them. It's not about
          liking or wanting them, but about dropping the struggle.
        </p>
      </div>
      ...
      {!completed ? (
        ...
        <div className="card bg-gradient-to-r from-pink-500 to-pink-600 text-white text-center py-12">
          ...
          <button
            onClick={handleReset}
            className="bg-white text-pink-600 px-8 py-3 rounded-lg font-semibold hover:bg-pink-50"
          >
            Start New Practice
          </button>
        </div>
