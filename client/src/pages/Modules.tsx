...
export default function Modules() {
  const [completedModules] = useState([1]); // Module 1 is completed
  ...
  const modules = [
    {
      ...
      duration: '30 mins',
      exercises: [
        { id: 'intro-act', name: 'Introduction to ACT', path: '/exercises/intro-act', completed: true },
        { id: 'values', name: 'Discovering Your Values', path: '/exercises/values', completed: true },
        { id: 'hexaflex', name: 'The ACT Hexaflex', path: '/hexaflex', completed: true },
      ],
    ...
    },
    {
      ...
      duration: '45 mins',
      exercises: [
        { id: 'mindfulness', name: 'Mindful Breathing', path: '/exercises/mindfulness', completed: false },
        { id: 'body-awareness', name: 'Body Awareness Scan', path: '/exercises/body-awareness', completed: false },
        { id: 'senses', name: '5 Senses Grounding', path: '/exercises/senses', completed: false },
      ],
    ...
    },
    {
      ...
      duration: '40 mins',
      exercises: [
        { id: 'defusion', name: 'Defusion Techniques', path: '/exercises/defusion', completed: false },
        { id: 'thought-watching', name: 'Thought Watching', path: '/exercises/thought-watching', completed: false },
    ...
    },
    {
      ...
      duration: '50 mins',
      exercises: [
        { id: 'acceptance', name: 'Acceptance Practice', path: '/exercises/acceptance', completed: false },
        { id: 'willingness', name: 'Willingness Exercise', path: '/exercises/willingness', completed: false },
        { id: 'self-compassion', name: 'Self-Compassion', path: '/exercises/self-compassion', completed: false },
      ],
    ...
    {
      id: 5,
      title: 'Module 4: Committed Action',
      description: 'Set values-aligned goals and take meaningful action',
      duration: '60 mins',
      exercises: [
        { id: 'action', name: 'Action Planning', path: '/exercises/action', completed: false },
        { id: 'barriers', name: 'Overcoming Barriers', path: '/exercises/barriers', completed: false },
        { id: 'goals', name: 'SMART Goals Workshop', path: '/exercises/goals', completed: false },
      ],
